          ...
          var scene = new THREE.Scene();
           var camera = new THREE.PerspectiveCamera(62, window.innerWidth / window.innerHeight, 0.1, 1000);
           var mouseX;
           var mouseY;
           ...
           var particles = new THREE.Points(geometry, new THREE.PointsMaterial({ color: 0xA020F0, size: 2 }));
           ...
           if (window.innerWidth <= 750) {
               gsap.to(animProps, {
                   duration: 10, scale: 2.5, repeat: -1, yoyo: true, ease: "sine", onUpdate: function () {
               ...
               gsap.to(animProps, {
                   duration: 7, scale: 1.5, repeat: -1, yoyo: true, ease: "sine", onUpdate: function () {
                       renderingParent.scale.set(animProps.scale, animProps.scale, animProps.scale);
                   }
               });
           }
           ...
           gsap.to(animProps, {
               duration: 110, xRot: Math.PI * 2, yRot: Math.PI * 5, repeat: -1, yoyo: true, ease: "none", onUpdate: function () {
           ...
           function navfunction() {
               ...
               let teamHeight = (document.getElementById('team').offsetTop - document.getElementById('team').scrollTop + document.getElementById('team').clientTop - 60);
               let faqHeight = (document.getElementById('FAQ').offsetTop - document.getElementById('FAQ').scrollTop + document.getElementById('FAQ').clientTop - 560);
               let footer = (document.getElementById('footer').offsetTop - document.getElementById('footer').scrollTop + document.getElementById('footer').clientTop - 460);
